...
function gameWonParty(moves) {
	const audio = new Audio('https://loudlinks.rocks/sounds/mp3/magic.mp3');
	audio.play();
	alert("Tôi cố 1 số seri "
+  " <b>602296592</b> còn lại 5 số bạn hãy giải đố những câu hỏi sau để lấy được mã seri  1) Số đuôi của năm hiện tại(2 số) "
  +" 2) (two x two + one + two - four/two - two x two + four x two - one)(1 số)"
  + "3) hai con số nào cộng lại thì bằng một gậy và một trứng chia ngỗng thì bằng 1/2 của gậy và trứng(2 số);  </b>"
	              )
